...
from . import views
from .views import editar_conductor, editar_ruta, eliminar_ruta, eliminar_todas_rutas, modulo_rutas, asignar_rutas, agregar_ruta, eliminar_conductor,activar_conductor
